...
const RuxButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("button", { type: "button", onClick: this.handleClick, class: {
      ...
      }, "aria-disabled": disabled ? 'true' : null, disabled: disabled }, icon ? (index.h("rux-icon", { size: "extra-small", icon: icon, color: secondary ? 'primary' : 'dark' })) : null, index.h("slot", null))));
  }
