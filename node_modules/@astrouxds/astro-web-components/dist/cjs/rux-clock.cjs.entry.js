...
const RuxClock = class {
  ...
  render() {
    return (index.h(index.Host, null, !this.hideDate && (index.h("div", { class: "rux-clock__segment rux-clock__day-of-the-year" }, index.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__day-of-year-label" }, this.dayOfYear), !this.hideLabels && (index.h("div", { class: "rux-clock__segment__label", id: "rux-clock__day-of-year-label" }, "Date")))), index.h("div", { class: "rux-clock__segment rux-clock__time" }, index.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label" }, this.time), !this.hideLabels && (index.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label" }, "Time"))), this.aos && (index.h("div", { class: "rux-clock__segment rux-clock__aos" }, index.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--aos", id: "rux-clock__time--aos" }, this.convertedAos), !this.hideLabels && (index.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--aos" }, "AOS")))), this.los && (index.h("div", { class: "rux-clock__segment rux-clock__los" }, index.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--los", id: "rux-clock__time--los" }, this.convertedLos), !this.hideLabels && (index.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--los" }, "LOS"))))));
  }
