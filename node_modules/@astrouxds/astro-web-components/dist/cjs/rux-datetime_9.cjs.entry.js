...
const RuxInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "rux-form-field", part: "form-field" }, index.h("label", { class: {
        ...
        hidden: !hasLabel,
      } }, index.h("slot", { name: "label", onSlotchange: _handleSlotChange }, label, required && (index.h("span", { class: "rux-input-label__asterisk" }, "*"))))), index.h("input", { name: name, disabled: disabled, type: _handleType(), "aria-invalid": invalid ? 'true' : 'false', placeholder: placeholder, required: required, step: step, min: min, max: max, value: value, class: {
        'rux-input': true,
      ...
      }, id: this.inputId, autoComplete: this.togglePassword ? 'off' : 'on', onChange: _onChange, onInput: _onInput, onBlur: _onBlur }), this.togglePassword && (index.h("div", { class: {
        'icon-container': true,
        'show-password': true,
        'with-label': hasLabel,
      } }, index.h("rux-icon", { part: "icon", onClick: _handleTogglePassword, icon: iconName, size: "extra-small" })))), index.h(FormFieldMessage.FormFieldMessage, { errorText: errorText, helpText: helpText })));
  }
