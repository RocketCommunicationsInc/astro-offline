...
const RuxRadioGroup = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this._handleClick }, index.h("div", { class: "rux-form-field", part: "form-field" }, index.h("div", { class: {
      ...
      }, part: "label" }, index.h("slot", { onSlotchange: this._handleSlotChange, name: "label" }, this.label)), index.h("div", { class: {
        'rux-radio-group': true,
        'rux-radio-group--invalid': this.invalid,
      }, role: "radiogroup", part: "radiogroup" }, index.h("slot", null))), index.h(FormFieldMessage.FormFieldMessage, { errorText: this.errorText, helpText: this.helpText })));
  }
