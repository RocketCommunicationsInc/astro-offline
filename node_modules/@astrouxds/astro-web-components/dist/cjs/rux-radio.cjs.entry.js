...
const RuxRadio = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "rux-form-field" }, index.h("div", { class: "rux-radio" }, index.h("input", { type: "radio", name: name, id: radioId, disabled: disabled, checked: checked, value: value, onChange: _onChange, onBlur: _onBlur }), index.h("label", { htmlFor: radioId }, index.h("slot", null, label)))));
  }
