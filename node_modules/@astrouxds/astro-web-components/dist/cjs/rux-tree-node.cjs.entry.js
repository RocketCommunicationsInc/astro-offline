...
const RuxTreeNode = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "treeitem", "aria-expanded": this.expanded ? 'true' : 'false', "aria-selected": this.selected ? 'true' : 'false', onClick: (event) => this._handleTreeNodeClick(event) }, index.h("div", { id: this.componentId, class: {
        'tree-node': true,
        'tree-node--expanded': this.expanded,
        'tree-node--has-children': this._hasChildren,
        'tree-node--selected': this.selected,
      } }, index.h("div", { class: "parent", tabindex: "0" }, this._hasChildren && (index.h("i", { onClick: (e) => this._handleArrowClick(e), class: "arrow" })), index.h("slot", { onSlotchange: this._handleSlotChange })), index.h("div", Object.assign({}, attrs, { class: "children" }), index.h("slot", { name: "node", onSlotchange: this._handleSlotChange })))));
  }
