...
const RuxMenuItem = class {
  constructor(hostRef) {
    ...
    this.ruxMenuItemSelected = index.createEvent(this, "ruxmenuitemselected", 7);
    /**
     * Disables the item
     */
    this.disabled = false;
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null }, index.h("li", null, index.h(TagType, Object.assign({}, attributes), index.h("slot", { name: "start" }), index.h("slot", null)))));
  }
