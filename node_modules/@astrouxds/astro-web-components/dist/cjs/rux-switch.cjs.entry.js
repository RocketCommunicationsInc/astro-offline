...
const RuxSwitch = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "rux-form-field", "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch" }, index.h("div", { class: {
        'rux-switch': true,
      } }, index.h("input", { role: "switch", type: "checkbox", class: "rux-switch__input", name: name, id: switchId, disabled: disabled, checked: checked, value: value, "aria-checked": `${checked}`, onChange: this._onChange, onInput: this._onInput, onBlur: this._onBlur }), index.h("label", { class: "rux-switch__button", htmlFor: switchId }, index.h("span", { class: {
        'rux-switch__label': true,
        hidden: !this.hasLabel,
      } }, index.h("slot", { onSlotchange: this._handleSlotChange, name: "label" }, this.label))))));
  }
