...
const RuxModal = class {
  constructor(hostRef) {
    ...
    this.ruxModalClosed = index.createEvent(this, "ruxmodalclosed", 7);
    /**
  ...
  render() {
    ...
    return (open && (index.h(index.Host, null, index.h("div", { part: "wrapper", class: "rux-modal__wrapper" }, index.h("dialog", { class: "rux-modal__dialog", role: "dialog" }, modalTitle && (index.h("header", { class: "rux-modal__titlebar" }, index.h("div", null, modalTitle))), index.h("div", { class: "rux-modal__content" }, index.h("div", { class: "rux-modal__message" }, modalMessage), index.h("rux-button-group", { "h-align": "right" }, index.h("rux-button", { secondary: confirmText.length > 0, onClick: _handleModalChoice, "data-value": "false", hidden: !denyText, tabindex: "-1" }, denyText), index.h("rux-button", { onClick: _handleModalChoice, "data-value": "true", hidden: !confirmText, tabindex: "0" }, confirmText))))))));
  }
