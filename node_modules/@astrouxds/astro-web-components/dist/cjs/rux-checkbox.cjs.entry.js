...
const RuxCheckbox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "rux-form-field" }, index.h("div", { class: {
        'rux-checkbox': true,
        'rux-checkbox--indeterminate': indeterminate,
        'rux-checkbox--has-text': helpText !== undefined,
      } }, index.h("input", { type: "checkbox", name: name, id: checkboxId, disabled: disabled, checked: checked,
      //Allows storybook's indetermiante control to take effect.
      indeterminate: indeterminate, value: value, onChange: this._onClick, onInput: this._onInput, onBlur: this._onBlur, ref: (el) => (this._inputEl = el) }), index.h("label", { htmlFor: checkboxId }, this.label, index.h("span", { class: {
        hidden: !!this.label,
      } }, index.h("slot", null))))), index.h(FormFieldMessage.FormFieldMessage, { helpText: helpText })));
  }
