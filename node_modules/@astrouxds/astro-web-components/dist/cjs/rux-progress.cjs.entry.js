...
const RuxProgress = class {
  ...
  render() {
    return (index.h(index.Host, null, this.value != undefined ? ([
      index.h("progress", { class: "rux-progress", value: this.value, max: this.max }),
      index.h("output", { class: "rux-progress__value", hidden: this.hideLabel }, this._getProgressAsString()),
    ]) : (index.h("progress", { class: "rux-progress" })), index.h("slot", null)));
  }
