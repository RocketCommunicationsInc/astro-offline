...
const RuxPopUpMenu = class {
  constructor(hostRef) {
    ...
    this.ruxMenuWillOpen = index.createEvent(this, "ruxmenuwillopen", 7);
    this.ruxMenuWillClose = index.createEvent(this, "ruxmenuwillclose", 7);
    this.ruxMenuDidOpen = index.createEvent(this, "ruxmenudidopen", 7);
    this.ruxMenuDidClose = index.createEvent(this, "ruxmenudidclose", 7);
    /**
  ...
  render() {
    return (index.h(index.Host, { "aria-hidden": !this.open ? 'true' : 'false' }, index.h("ul", { role: "menu", "aria-expanded": `${this.open}` }, index.h("slot", null)), index.h("slot", { name: "menu-end" })));
  }
...
exports.rux_pop_up_menu = RuxPopUpMenu;
