...
const MonitoringBadge = ({ notifications, }) => (index.h("div", { class: `rux-advanced-status__badge ${!notifications ? 'rux-advanced-status__hidden' : ''}` }, notifications && collapseNotifications(notifications)));

const MonitoringLabel = ({ label, sublabel, }) => (index.h("div", { class: "rux-advanced-status__label" },
  label,
  index.h("span", { class: `rux-advanced-status__sublabel ${!sublabel ? 'rux-advanced-status__hidden' : ''}` }, sublabel)));
