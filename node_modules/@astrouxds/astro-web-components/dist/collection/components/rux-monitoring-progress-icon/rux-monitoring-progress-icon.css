...
svg.rux-status--off {
  stroke: var(--color-status-off-fill, #9ea7ad);
  fill: var(--color-status-off-fill, #9ea7ad);
}

svg.rux-status--standby {
  stroke: var(--color-status-standby-fill, #2dccff);
  fill: var(--color-status-standby-fill, #2dccff);
}

svg.rux-status--normal {
  stroke: var(--color-status-normal-fill, #56f000);
  fill: var(--color-status-normal-fill, #56f000);
}

svg.rux-status--caution {
  stroke: var(--color-status-caution-fill, #fce83a);
  fill: var(--color-status-caution-fill, #fce83a);
}

svg.rux-status--serious {
  stroke: var(--color-status-serious-fill, #ffb300);
  fill: var(--color-status-serious-fill, #ffb300);
}

svg.rux-status--critical {
  stroke: var(--color-status-critical-fill, #ff3838);
  fill: var(--color-status-critical-fill, #ff3838);
}
