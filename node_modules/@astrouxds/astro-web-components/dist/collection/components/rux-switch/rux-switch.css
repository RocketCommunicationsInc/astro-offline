...
:host {
  ...
  /**
    ...
    */
  --switch-background-color: var(--color-background);
  /**
    * @prop --switch-hover-on-color: the Switch hover on color
    */
  --switch-hover-on-color: var(--color-primary);
  /**
    * @prop --switch-hover-off-color: the Switch hover off color
    */
  --switch-hover-off-color: var(--color-primary);
  ...
  --switch-off-border-color: var(--color-active);
  padding-left: 1%;
}
