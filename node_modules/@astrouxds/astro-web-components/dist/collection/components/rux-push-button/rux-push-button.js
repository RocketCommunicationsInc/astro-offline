import { Prop, Component, Host, h, Event, Element, } from '@stencil/core';
...
export class RuxPushButton {
  ...
  render() {
    ...
    return (h(Host, { "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch" },
      h("input", { class: "rux-push-button__input", id: this.pushButtonId, type: "checkbox", disabled: disabled, checked: checked, onChange: _onChange, onBlur: _onBlur, value: value }),
      h("label", { class: {
        ...
        icon ? (h("rux-icon", { size: "extra-small", icon: icon })) : null,
        label),
      h("slot", null)));
  }
