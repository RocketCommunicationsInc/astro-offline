...
export class RuxButton {
  ...
  render() {
    ...
    return (h(Host, null,
      h("button", { type: "button", onClick: this.handleClick, class: {
          'rux-button': true,
        ...
        }, "aria-disabled": disabled ? 'true' : null, disabled: disabled },
        icon ? (h("rux-icon", { size: "extra-small", icon: icon, color: secondary ? 'primary' : 'dark' })) : null,
        h("slot", null))));
  }
  ...
  static get properties() { return {
    ...
    "secondary": {
      ...
      "docs": {
        "tags": [],
        "text": "Changes button style from solid to secondary by setting rux-button--secondary class"
      },
      "attribute": "secondary",
      "reflect": false,
      "defaultValue": "false"
